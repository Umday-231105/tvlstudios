...
export default function StartProjectPage() {
  ...
  useEffect(() => {
    // reset success message if user edits
  ...
  const handleSubmit = (ev) => {
    ...
    // In production you would send to your API. For now:
    console.log("Start project submission:", form);

    // fallback: open mailto (pre-fill) - optional behavior; you can remove if you have API
  ...
  return (
    ...
    >
      {/* Background layers (z-0 so footer/content remain visible) */}
      {theme !== "dark" && (
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-6 py-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-6">
            <div className="rounded-3xl border border-neutral-200 dark:border-neutral-800 bg-white/70 dark:bg-neutral-900/80 backdrop-blur-2xl p-8 shadow-lg">
              <h1 className="text-3xl md:text-4xl font-semibold mb-3">Start a project</h1>
              <p className="text-sm text-neutral-700 dark:text-neutral-300">
                Tell us about your idea — timing, context, and goals. We’ll respond with availability, a rough scope, and next steps.
              </p>

              <ul className="mt-6 text-sm text-neutral-700 dark:text-neutral-300 space-y-3">
                <li>✅ Focused teams for product, marketing and brand</li>
                <li>✅ Clear phases: discover → design → build → launch</li>
                <li>✅ Flexible engagement: fixed price or retainers</li>
              </ul>
            </div>

            <div className="rounded-3xl border border-neutral-200 dark:border-neutral-800 bg-white/70 dark:bg-neutral-900/80 backdrop-blur-2xl p-6 shadow-sm">
              <h3 className="font-medium mb-2 text-neutral-900 dark:text-neutral-50">How we work</h3>
              <p className="text-sm text-neutral-700 dark:text-neutral-300">
                We pair design and engineering to move quickly while keeping quality high. You’ll get a clear timeline and deliverables before any heavy development starts.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    } bg-white/90 dark:bg-neutral-900/70 text-sm outline-none`}
                ...
                <div>
                  <label className="text-xs font-semibold block mb-1">Company (optional)</label>
                  <input
                    value={form.company}
                    onChange={(e) => setForm((s) => ({ ...s, company: e.target.value }))}
                    className="w-full rounded-md px-3 py-2 border border-neutral-200 dark:border-neutral-700 bg-white/90 dark:bg-neutral-900/70 text-sm outline-none"
                    placeholder="Company or project name"
                  />
                </div>

                <div>
                  <label className="text-xs font-semibold block mb-1">Budget (optional)</label>
                  <select
                    value={form.budget}
                ...
                <div className="md:col-span-2">
                  <label className="text-xs font-semibold block mb-1">Timeline (optional)</label>
                  <input
                    value={form.timeline}
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    } bg-white/90 dark:bg-neutral-900/70 text-sm outline-none resize-none`}
              ...
              <div className="mt-6 flex items-center gap-3">
                <button
                  type="submit"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-neutral-900 text-white text-sm font-semibold hover:bg-neutral-800 transition"
                >
                  Send inquiry
                ...
                <button
                  ...
                  className="text-sm px-4 py-2 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white/70 dark:bg-neutral-900/70"
                >
                  Reset
                </button>

                {submitted && (
                  <div className="ml-2 text-sm text-emerald-600">Thanks — your message has been opened in your mail client.</div>
                )}
              </div>
            </form>
          </div>
        ...
        {/* optional FAQ or Notes */}
        <div className="mt-10 rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white/70 dark:bg-neutral-900/80 p-6 text-sm text-neutral-700 dark:text-neutral-300">
          <strong>What to expect</strong>
          <p className="mt-2">
            After you submit, we’ll review details and reply with availability and a suggested next step — usually within 24–48 hours.
          </p>
        </div>
      </main>
